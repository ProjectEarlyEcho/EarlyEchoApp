...
> {
  ...
  const [childrenResponse, screeningsResponse, appointmentsResponse] = await Promise.all([
  ...
  const error = [childrenResponse.error, screeningsResponse.error, appointmentsResponse.error]
